...
class user_login():
    ...
    def lables_and_entries(self, Text, X, Y):
        ...
        :return: None
        """
        Label(self.lbl, text=Text, justify=LEFT, compound=LEFT, font=10, bg="black", fg="white", width=12).grid(row=X,
                                                                                                                column=Y)
    ...
    def detail_label(self, Text, X, Y):
        """Creates labels for personal informations
                ...
                :return: None
                """
        Label(self.lbl2, text=Text, justify=LEFT, compound=LEFT, font=12, bg="black", fg="white").grid(row=X, column=Y,
                                                                                                       sticky=NSEW)
    ...
    def DataBase_Calls(self):
        ...
        Tot = Label(self.lbl3, text=str(Total), font=('Helvetica', 15), bg="black", fg="white", justify=CENTER,
                    anchor=CENTER)
